...
export const stations = [
  ...
  { id: 105, name: "중앙로", displayName: "중앙로", order: 5, isTerminal: false },
  { id: 106, name: "중구청", displayName: "중구청", order: 6, isTerminal: false },
  {
    id: 107,
    name: "서대전 네거리",
    displayName: "서대전 네거리",
  ...
  { id: 112, name: "정부청사", displayName: "정부청사", order: 12, isTerminal: false },
  ...
  { id: 116, name: "유성온천", displayName: "유성온천", order: 16, isTerminal: false },
  { id: 117, name: "구암", displayName: "구암", order: 17, isTerminal: false },
  { id: 118, name: "현충원", displayName: "현충원", order: 18, isTerminal: false },
  {
    id: 119,
    name: "월드컵 경기장",
    displayName: "월드컵 경기장",
